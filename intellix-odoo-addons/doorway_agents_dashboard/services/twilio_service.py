...
class TwilioService:
    ...
    def _config(self):
        return {
            "sid": self._icp.get_param("doorway_agents_dashboard.twilio_account_sid")
            or self._icp.get_param("doorway_agents_ia.twilio_account_sid")
            or self._icp.get_param("renovation_conciergerie.twilio_account_sid", ""),
            "token": self._icp.get_param("doorway_agents_dashboard.twilio_auth_token")
            or self._icp.get_param("doorway_agents_ia.twilio_auth_token")
            or self._icp.get_param("renovation_conciergerie.twilio_auth_token", ""),
            "from": self._icp.get_param("doorway_agents_dashboard.twilio_phone_number")
            or self._icp.get_param("doorway_agents_ia.twilio_phone_number")
    ...
    def connect_elevenlabs_agent(self, call_sid, agent):
        ...
        if not agent:
            return False
        try:
            from odoo.addons.doorway_agents_dashboard.services.elevenlabs_service import ElevenlabsService
