...
export class RenoMartinSlotsField extends Component {
    static template = "renovation_conciergerie.RenoMartinSlotsField";
...
registry.category("fields").add("reno_martin_slots", {
    component: RenoMartinSlotsField,
    supportedTypes: ["char"],
});
