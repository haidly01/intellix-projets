...
NAME = "SE — Subventions thermopompe"
XMLID = "renovation_conciergerie.mail_template_se_thermopompe"
HTML_PATH = Path("/odoo/custom/addons/renovation_conciergerie/data/email_se_thermopompe.html")
...
vals = {
    "name": NAME,
    "model_id": model.id,
    "subject": "Des subventions pourraient réduire le coût de votre thermopompe",
    "body_html": BODY,
...
if not env.ref(XMLID, raise_if_not_found=False):
    env["ir.model.data"].sudo().create({
        "name": "mail_template_se_thermopompe",
