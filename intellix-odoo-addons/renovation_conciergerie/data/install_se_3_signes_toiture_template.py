...
NAME = "SE — 3 signes toiture"
XMLID = "renovation_conciergerie.mail_template_se_3_signes_toiture"
HTML_PATH = Path("/odoo/custom/addons/renovation_conciergerie/data/email_se_3_signes_toiture.html")
...
vals = {
    "name": NAME,
    "model_id": model.id,
    "subject": "3 signes qu'il est temps de refaire votre toiture",
    "body_html": BODY,
...
if not env.ref(XMLID, raise_if_not_found=False):
    env["ir.model.data"].sudo().create({
        "name": "mail_template_se_3_signes_toiture",
