...
NAME = "SE — Fenêtres et courants d'air"
XMLID = "renovation_conciergerie.mail_template_se_fenetres"
HTML_PATH = Path("/odoo/custom/addons/renovation_conciergerie/data/email_se_fenetres.html")
...
vals = {
    "name": NAME,
    "model_id": model.id,
    "subject": "Vos fenêtres vous coûtent peut-être plus cher que vous pensez",
    "body_html": BODY,
...
if not env.ref(XMLID, raise_if_not_found=False):
    env["ir.model.data"].sudo().create({
        "name": "mail_template_se_fenetres",
