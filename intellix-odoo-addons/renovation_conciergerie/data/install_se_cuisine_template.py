...
NAME = "SE — Idées projet cuisine"
XMLID = "renovation_conciergerie.mail_template_se_cuisine"
HTML_PATH = Path("/odoo/custom/addons/renovation_conciergerie/data/email_se_cuisine.html")
...
vals = {
    "name": NAME,
    "model_id": model.id,
    "subject": "Des idées pour votre projet de cuisine",
    "body_html": BODY,
