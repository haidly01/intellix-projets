...
NAME = "SE — Projets rénovation qui inspirent"
XMLID = "renovation_conciergerie.mail_template_se_renovation"
HTML_PATH = Path("/odoo/custom/addons/renovation_conciergerie/data/email_se_renovation.html")
...
vals = {
    "name": NAME,
    "model_id": model.id,
    "subject": "Des projets de rénovation qui inspirent",
    "body_html": BODY,
...
if not env.ref(XMLID, raise_if_not_found=False):
    env["ir.model.data"].sudo().create({
        "name": "mail_template_se_renovation",
