...
SPECS = [
    ("01_outbound.json", "lea-qc — 01 Outbound", "lea-qc/outbound", "Outbound Dial"),
    ("02_telephony_events.json", "lea-qc — 02 Telephony Events", "lea-qc/event", "Telephony Events"),
    ("03_conversation_engine.json", "lea-qc — 03 Conversation Engine", "lea-qc/conversation", "Sofia QC Engine"),
    ("04_qualified_lead.json", "lea-qc — 04 Lead Qualifié", "lea-qc/qualified", "Qualified Lead"),
    ("05_non_qualified_lead.json", "lea-qc — 05 Lead Non Qualifié", "lea-qc/non-qualified", "Non Qualified"),
    ("06_daily_stats.json", "lea-qc — 06 Stats Quotidiennes", "lea-qc/stats", "Daily Stats"),
]
