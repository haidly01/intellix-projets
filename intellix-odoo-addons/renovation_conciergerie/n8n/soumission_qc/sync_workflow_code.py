#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Injecte le code JS dans les workflows Soumission QC."""
...
INJECTIONS = {
    ...
    "03_conversation_engine.json": {
        "Sofia QC Engine": (
            "soumission_qc_config.js",
            "sofia_intent_keywords.js",
            "conversation_sofia_process.js",
        ),
    },
    "04_qualified_lead.json": {"Qualified Lead": "qualified_lead.js"},
...
def main() -> None:
    ...
    print("Soumission QC workflow code synced.")
