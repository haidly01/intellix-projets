...
class CoinsQuebecAssigneeMixin(models.AbstractModel):
    """Même mécanisme que coins.assignee.mixin (CM) : humain + IA.

    Module séparé : pas de dépendance vers coins_marocain_partenariats.
    """

    _name = "coins.quebec.assignee.mixin"
    _description = "Assigné commercial humain ou agent IA (Coins Québec)"
