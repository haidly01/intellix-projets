...
class VicidialService:
    ...
    def _config(self):
        ...
        return {
            "host": self._icp.get_param("doorway_agents_ia.vicidial_db_host", "127.0.0.1"),
            "port": int(self._icp.get_param("doorway_agents_ia.vicidial_db_port", "3307") or 3307),
            "user": self._icp.get_param("doorway_agents_ia.vicidial_db_user", "vicidial"),
            "password": self._icp.get_param("doorway_agents_ia.vicidial_db_password", ""),
            "database": self._icp.get_param("doorway_agents_ia.vicidial_db_name", "asterisk"),
        }
