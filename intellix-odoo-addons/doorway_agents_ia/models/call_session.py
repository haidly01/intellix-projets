...
from odoo.addons.doorway_agents_ia.services.claude_service import ClaudeService
...
class DoorwayCallSession(models.Model):
    ...
    agent_id = fields.Many2one("doorway.agent.ia", string="Agent IA", tracking=True)
